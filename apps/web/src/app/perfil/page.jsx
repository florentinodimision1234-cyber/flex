...
function iconoRed(tipo) {
  if (tipo === 'Visa') return (
    <span className="text-blue-400 font-black italic text-sm tracking-tight">VISA</span>
  )
  return (
    <span className="text-red-400 font-black text-xs">MC</span>
  )
}
    ...
    <div className="p-4 sm:p-8 max-w-2xl">
      ...
      <div className="flex items-center gap-5 mb-8">
        <div className="relative">
          <div className="w-20 h-20 rounded-full bg-gold-500/20 border-2 border-gold-500/40 overflow-hidden flex items-center justify-center">
            {avatar
              ...
              : <span className="text-3xl font-bold text-gold-400">A</span>
            }
          </div>
        ...
        <div>
          ...
          <span className="text-xs bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded-full mt-1 inline-block">Cliente</span>
        </div>
      </div>
            ...
            <form onSubmit={agregarTarjeta} className="bg-zinc-900 border border-zinc-700 rounded-2xl p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e => setFormTarjeta(p => ({ ...p, numero: e.target.value }))}
                  maxLength={19}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    placeholder="MM/AA"
                    value={formTarjeta.expira}
                    onChange={e => setFormTarjeta(p => ({ ...p, expira: e.target.value }))}
                    maxLength={5}
                    className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-2.5 text-sm text-zinc-100 font-mono outline-none focus:border-gold-500 transition-colors"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={e => setFormTarjeta(p => ({ ...p, cvv: e.target.value }))}
                    maxLength={4}
                    className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-2.5 text-sm text-zinc-100 font-mono outline-none focus:border-gold-500 transition-colors"
                  />
                </div>
